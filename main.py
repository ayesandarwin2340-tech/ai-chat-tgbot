...
# -----------------------------
CONFIG = {
    "API_ID": int(os.getenv("API_ID", "0")), # ပြောင်းထားသည်
    "API_HASH": os.getenv("API_HASH"),       # ပြောင်းထားသည်
    "SESSION_NAME": os.getenv("SESSION_NAME", "janab_pro_session"),
    "BOT_TOKEN": os.getenv("BOT_TOKEN"),     # ပြောင်းထားသည်
    "GEMINI_API_KEY": os.getenv("GEMINI_API_KEY"), # ပြောင်းထားသည်
    "OWNER_CHAT_ID": int(os.getenv("OWNER_CHAT_ID", "0")), # ပြောင်းထားသည်
    "ADMIN_IDS": [int(x) for x in os.getenv("ADMIN_IDS", "").split(",") if x], # ပြောင်းထားသည်
